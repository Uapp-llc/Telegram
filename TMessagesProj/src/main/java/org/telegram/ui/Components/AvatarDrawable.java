...
public class AvatarDrawable extends Drawable {
    ...
    public static final int AVATAR_TYPE_CATEGORY = 4;
    ...
    public void setAvatarType(int value) {
        ...
        } else if(avatarType ==AVATAR_TYPE_CATEGORY){
            color = Theme.getColor(Theme.key_avatar_backgroundArchived);
        }else {
    ...
    public void setInfo(int id, String firstName, String lastName, String custom) {
        ...
        buildAvatarLetter(firstName, lastName, custom);
    }

    public void buildAvatarLetter(String firstName, String lastName, String custom){
    ...
    public void draw(Canvas canvas) {
        ...
        if (avatarType == AVATAR_TYPE_ARCHIVED) {
            ...
            canvas.restore();
        } else if (avatarType != 0 && avatarType != AVATAR_TYPE_CATEGORY && Theme.avatar_savedDrawable != null) {
